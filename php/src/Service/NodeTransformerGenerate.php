...
class NodeTransformerGenerate extends NodeTransformer
{
    ...
    protected function visitScalarMagicConstClass(Node\Scalar\MagicConst\Class_ $node): ?Fragment\Expr
    {
        throw new TodoException("TODO NodeTransformer::visitScalarMagicConstClass");
    }
    ...
    protected function visitScalarMagicConstFunction(Node\Scalar\MagicConst\Function_ $node): ?Fragment\Expr
    {
        throw new TodoException("TODO NodeTransformer::visitScalarMagicConstFunction");
    }
    ...
    protected function visitScalarMagicConstNamespace(Node\Scalar\MagicConst\Namespace_ $node): ?Fragment\Expr
    {
        throw new TodoException("TODO NodeTransformer::visitScalarMagicConstNamespace");
    }

    protected function visitScalarMagicConstTrait(Node\Scalar\MagicConst\Trait_ $node): ?Fragment\Expr
    {
        throw new TodoException("TODO NodeTransformer::visitScalarMagicConstTrait");
    }

    protected function visitScalarString(Node\Scalar\String_ $node): ?Fragment\Expr
    {
        throw new TodoException("TODO NodeTransformer::visitScalarString");
    }
