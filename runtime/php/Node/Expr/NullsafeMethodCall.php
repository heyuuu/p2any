...
class NullsafeMethodCall extends \P2Any\PhpParser\Node\Expr\CallLike
{
     ...
     */
    public function __construct(\P2Any\PhpParser\Node\Expr $var, $name, array $args = [], array $attributes = [])
    {
