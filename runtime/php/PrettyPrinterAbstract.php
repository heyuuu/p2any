...
use P2Any\PhpParser\Internal\DiffElem;
use P2Any\PhpParser\Internal\PrintableNewAnonClassNode;
...
abstract class PrettyPrinterAbstract
{
    ...
    protected $precedenceMap = [
        ...
        \P2Any\PhpParser\Node\Expr\BinaryOp\Pow::class => [0, 1],
        \P2Any\PhpParser\Node\Expr\BitwiseNot::class => [10, 1],
        \P2Any\PhpParser\Node\Expr\PreInc::class => [10, 1],
        \P2Any\PhpParser\Node\Expr\PreDec::class => [10, 1],
        \P2Any\PhpParser\Node\Expr\PostInc::class => [10, -1],
        \P2Any\PhpParser\Node\Expr\PostDec::class => [10, -1],
        \P2Any\PhpParser\Node\Expr\UnaryPlus::class => [10, 1],
        \P2Any\PhpParser\Node\Expr\UnaryMinus::class => [10, 1],
        \P2Any\PhpParser\Node\Expr\Cast\Int_::class => [10, 1],
        \P2Any\PhpParser\Node\Expr\Cast\Double::class => [10, 1],
        \P2Any\PhpParser\Node\Expr\Cast\String_::class => [10, 1],
        \P2Any\PhpParser\Node\Expr\Cast\Array_::class => [10, 1],
        \P2Any\PhpParser\Node\Expr\Cast\Object_::class => [10, 1],
        \P2Any\PhpParser\Node\Expr\Cast\Bool_::class => [10, 1],
        \P2Any\PhpParser\Node\Expr\Cast\Unset_::class => [10, 1],
        \P2Any\PhpParser\Node\Expr\ErrorSuppress::class => [10, 1],
        \P2Any\PhpParser\Node\Expr\Instanceof_::class => [20, 0],
        \P2Any\PhpParser\Node\Expr\BooleanNot::class => [30, 1],
        \P2Any\PhpParser\Node\Expr\BinaryOp\Mul::class => [40, -1],
        \P2Any\PhpParser\Node\Expr\BinaryOp\Div::class => [40, -1],
        \P2Any\PhpParser\Node\Expr\BinaryOp\Mod::class => [40, -1],
        \P2Any\PhpParser\Node\Expr\BinaryOp\Plus::class => [50, -1],
        \P2Any\PhpParser\Node\Expr\BinaryOp\Minus::class => [50, -1],
        \P2Any\PhpParser\Node\Expr\BinaryOp\Concat::class => [50, -1],
        \P2Any\PhpParser\Node\Expr\BinaryOp\ShiftLeft::class => [60, -1],
        \P2Any\PhpParser\Node\Expr\BinaryOp\ShiftRight::class => [60, -1],
        \P2Any\PhpParser\Node\Expr\BinaryOp\Smaller::class => [70, 0],
        \P2Any\PhpParser\Node\Expr\BinaryOp\SmallerOrEqual::class => [70, 0],
        \P2Any\PhpParser\Node\Expr\BinaryOp\Greater::class => [70, 0],
        \P2Any\PhpParser\Node\Expr\BinaryOp\GreaterOrEqual::class => [70, 0],
        \P2Any\PhpParser\Node\Expr\BinaryOp\Equal::class => [80, 0],
        \P2Any\PhpParser\Node\Expr\BinaryOp\NotEqual::class => [80, 0],
        \P2Any\PhpParser\Node\Expr\BinaryOp\Identical::class => [80, 0],
        \P2Any\PhpParser\Node\Expr\BinaryOp\NotIdentical::class => [80, 0],
        \P2Any\PhpParser\Node\Expr\BinaryOp\Spaceship::class => [80, 0],
        \P2Any\PhpParser\Node\Expr\BinaryOp\BitwiseAnd::class => [90, -1],
        \P2Any\PhpParser\Node\Expr\BinaryOp\BitwiseXor::class => [100, -1],
        \P2Any\PhpParser\Node\Expr\BinaryOp\BitwiseOr::class => [110, -1],
        \P2Any\PhpParser\Node\Expr\BinaryOp\BooleanAnd::class => [120, -1],
        \P2Any\PhpParser\Node\Expr\BinaryOp\BooleanOr::class => [130, -1],
        \P2Any\PhpParser\Node\Expr\BinaryOp\Coalesce::class => [140, 1],
        \P2Any\PhpParser\Node\Expr\Ternary::class => [150, 0],
        // parser uses %left for assignments, but they really behave as %right
        \P2Any\PhpParser\Node\Expr\Assign::class => [160, 1],
        \P2Any\PhpParser\Node\Expr\AssignRef::class => [160, 1],
        \P2Any\PhpParser\Node\Expr\AssignOp\Plus::class => [160, 1],
        \P2Any\PhpParser\Node\Expr\AssignOp\Minus::class => [160, 1],
        \P2Any\PhpParser\Node\Expr\AssignOp\Mul::class => [160, 1],
        \P2Any\PhpParser\Node\Expr\AssignOp\Div::class => [160, 1],
        \P2Any\PhpParser\Node\Expr\AssignOp\Concat::class => [160, 1],
        \P2Any\PhpParser\Node\Expr\AssignOp\Mod::class => [160, 1],
        \P2Any\PhpParser\Node\Expr\AssignOp\BitwiseAnd::class => [160, 1],
        \P2Any\PhpParser\Node\Expr\AssignOp\BitwiseOr::class => [160, 1],
        \P2Any\PhpParser\Node\Expr\AssignOp\BitwiseXor::class => [160, 1],
        \P2Any\PhpParser\Node\Expr\AssignOp\ShiftLeft::class => [160, 1],
        \P2Any\PhpParser\Node\Expr\AssignOp\ShiftRight::class => [160, 1],
        \P2Any\PhpParser\Node\Expr\AssignOp\Pow::class => [160, 1],
        \P2Any\PhpParser\Node\Expr\AssignOp\Coalesce::class => [160, 1],
        \P2Any\PhpParser\Node\Expr\YieldFrom::class => [165, 1],
        \P2Any\PhpParser\Node\Expr\Print_::class => [168, 1],
        \P2Any\PhpParser\Node\Expr\BinaryOp\LogicalAnd::class => [170, -1],
        \P2Any\PhpParser\Node\Expr\BinaryOp\LogicalXor::class => [180, -1],
        \P2Any\PhpParser\Node\Expr\BinaryOp\LogicalOr::class => [190, -1],
        \P2Any\PhpParser\Node\Expr\Include_::class => [200, -1],
    ];
     ...
     */
    public function prettyPrintExpr(\P2Any\PhpParser\Node\Expr $node) : string
    {
        $this->resetState();
    ...
    public function prettyPrintFile(array $stmts) : string
    {
        ...
        if ($stmts[0] instanceof \P2Any\PhpParser\Node\Stmt\InlineHTML) {
            $p = preg_replace('/^<\\?php\\s+\\?>\\n?/', '', $p);
        }
        if ($stmts[count($stmts) - 1] instanceof \P2Any\PhpParser\Node\Stmt\InlineHTML) {
    ...
    protected function preprocessNodes(array $nodes)
    {
        ...
        foreach ($nodes as $node) {
            if ($node instanceof \P2Any\PhpParser\Node\Stmt\Namespace_ && null === $node->name) {
    ...
    protected function pStmts(array $nodes, bool $indent = true) : string
    {
        ...
        foreach ($nodes as $node) {
            ...
            if ($comments) {
                ...
                if ($node instanceof \P2Any\PhpParser\Node\Stmt\Nop) {
                    continue;
                }
            }
     ...
     */
    protected function pInfixOp(string $class, \P2Any\PhpParser\Node $leftNode, string $operatorString, \P2Any\PhpParser\Node $rightNode) : string
    {
     ...
     */
    protected function pPrefixOp(string $class, string $operatorString, \P2Any\PhpParser\Node $node) : string
    {
        list($precedence, $associativity) = $this->precedenceMap[$class];
     ...
     */
    protected function pPostfixOp(string $class, \P2Any\PhpParser\Node $node, string $operatorString) : string
    {
        list($precedence, $associativity) = $this->precedenceMap[$class];
     ...
     */
    protected function pPrec(\P2Any\PhpParser\Node $node, int $parentPrecedence, int $parentAssociativity, int $childPosition) : string
    {
    ...
    public function printFormatPreserving(array $stmts, array $origStmts, array $origTokens) : string
    {
        ...
        $this->resetState();
        $this->origTokens = new \P2Any\PhpParser\Internal\TokenStream($origTokens);
        $this->preprocessNodes($stmts);
        $pos = 0;
    ...
    protected function pFallback(\P2Any\PhpParser\Node $node)
    {
     ...
     * @return string Pretty printed node
     */
    protected function p(\P2Any\PhpParser\Node $node, $parentFormatPreserved = false) : string
    {
        ...
        $fallbackNode = $node;
        if ($node instanceof \P2Any\PhpParser\Node\Expr\New_ && $node->class instanceof \P2Any\PhpParser\Node\Stmt\Class_) {
            // Normalize node structure of anonymous classes
            $node = \P2Any\PhpParser\Internal\PrintableNewAnonClassNode::fromNewNode($node);
            $origNode = \P2Any\PhpParser\Internal\PrintableNewAnonClassNode::fromNewNode($origNode);
        }
        ...
        // printed.
        if ($node instanceof \P2Any\PhpParser\Node\Stmt\InlineHTML && !$parentFormatPreserved) {
        ...
        foreach ($node->getSubNodeNames() as $subNodeName) {
            ...
            if (!$subNode instanceof \P2Any\PhpParser\Node && $subNode !== null || !$origSubNode instanceof \P2Any\PhpParser\Node && $origSubNode !== null) {
    ...
    protected function pArray(array $nodes, array $origNodes, int &$pos, int $indentAdjustment, string $parentNodeType, string $subNodeName, $fixup)
    {
        ...
        foreach ($diff as $i => $diffElem) {
            ...
            if ($diffType === \P2Any\PhpParser\Internal\DiffElem::TYPE_KEEP || $diffType === \P2Any\PhpParser\Internal\DiffElem::TYPE_REPLACE) {
                ...
                if (!$arrItem instanceof \P2Any\PhpParser\Node || !$origArrItem instanceof \P2Any\PhpParser\Node) {
                ...
                $skipRemovedNode = false;
            } elseif ($diffType === \P2Any\PhpParser\Internal\DiffElem::TYPE_ADD) {
                if (null === $insertStr) {
            ...
            } elseif ($diffType === \P2Any\PhpParser\Internal\DiffElem::TYPE_REMOVE) {
                if (!$origArrItem instanceof \P2Any\PhpParser\Node) {
     ...
     */
    protected function pFixup(int $fixup, \P2Any\PhpParser\Node $subNode, $parentClass, int $subStartPos, int $subEndPos) : string
    {
        switch ($fixup) {
            ...
            case self::FIXUP_VAR_BRACED_NAME:
                if ($subNode instanceof \P2Any\PhpParser\Node\Expr && !$this->origTokens->haveBraces($subStartPos, $subEndPos)) {
                    return ($fixup === self::FIXUP_VAR_BRACED_NAME ? '$' : '') . '{' . $this->p($subNode) . '}';
                }
                break;
            case self::FIXUP_ENCAPSED:
                if (!$subNode instanceof \P2Any\PhpParser\Node\Scalar\EncapsedStringPart && !$this->origTokens->haveBraces($subStartPos, $subEndPos)) {
                    return '{' . $this->p($subNode) . '}';
                }
                break;
            default:
     ...
     */
    protected function callLhsRequiresParens(\P2Any\PhpParser\Node $node) : bool
    {
        return !($node instanceof \P2Any\PhpParser\Node\Name || $node instanceof \P2Any\PhpParser\Node\Expr\Variable || $node instanceof \P2Any\PhpParser\Node\Expr\ArrayDimFetch || $node instanceof \P2Any\PhpParser\Node\Expr\FuncCall || $node instanceof \P2Any\PhpParser\Node\Expr\MethodCall || $node instanceof \P2Any\PhpParser\Node\Expr\NullsafeMethodCall || $node instanceof \P2Any\PhpParser\Node\Expr\StaticCall || $node instanceof \P2Any\PhpParser\Node\Expr\Array_);
    }
    /**
     ...
     * @return bool Whether parentheses are required
     */
    protected function dereferenceLhsRequiresParens(\P2Any\PhpParser\Node $node) : bool
    {
        return !($node instanceof \P2Any\PhpParser\Node\Expr\Variable || $node instanceof \P2Any\PhpParser\Node\Name || $node instanceof \P2Any\PhpParser\Node\Expr\ArrayDimFetch || $node instanceof \P2Any\PhpParser\Node\Expr\PropertyFetch || $node instanceof \P2Any\PhpParser\Node\Expr\NullsafePropertyFetch || $node instanceof \P2Any\PhpParser\Node\Expr\StaticPropertyFetch || $node instanceof \P2Any\PhpParser\Node\Expr\FuncCall || $node instanceof \P2Any\PhpParser\Node\Expr\MethodCall || $node instanceof \P2Any\PhpParser\Node\Expr\NullsafeMethodCall || $node instanceof \P2Any\PhpParser\Node\Expr\StaticCall || $node instanceof \P2Any\PhpParser\Node\Expr\Array_ || $node instanceof \P2Any\PhpParser\Node\Scalar\String_ || $node instanceof \P2Any\PhpParser\Node\Expr\ConstFetch || $node instanceof \P2Any\PhpParser\Node\Expr\ClassConstFetch);
    }
    /**
    ...
    {
        return ($modifiers & \P2Any\PhpParser\Node\Stmt\Class_::MODIFIER_PUBLIC ? 'public ' : '') . ($modifiers & \P2Any\PhpParser\Node\Stmt\Class_::MODIFIER_PROTECTED ? 'protected ' : '') . ($modifiers & \P2Any\PhpParser\Node\Stmt\Class_::MODIFIER_PRIVATE ? 'private ' : '') . ($modifiers & \P2Any\PhpParser\Node\Stmt\Class_::MODIFIER_STATIC ? 'static ' : '') . ($modifiers & \P2Any\PhpParser\Node\Stmt\Class_::MODIFIER_ABSTRACT ? 'abstract ' : '') . ($modifiers & \P2Any\PhpParser\Node\Stmt\Class_::MODIFIER_FINAL ? 'final ' : '') . ($modifiers & \P2Any\PhpParser\Node\Stmt\Class_::MODIFIER_READONLY ? 'readonly ' : '');
    }
    /**
    ...
    protected function initializeNodeListDiffer()
    {
        ...
        $this->nodeListDiffer = new \P2Any\PhpParser\Internal\Differ(function ($a, $b) {
            if ($a instanceof \P2Any\PhpParser\Node && $b instanceof \P2Any\PhpParser\Node) {
    ...
    protected function initializeFixupMap()
    {
        ...
        $this->fixupMap = [
            \P2Any\PhpParser\Node\Expr\PreInc::class => ['var' => self::FIXUP_PREC_RIGHT],
            \P2Any\PhpParser\Node\Expr\PreDec::class => ['var' => self::FIXUP_PREC_RIGHT],
            \P2Any\PhpParser\Node\Expr\PostInc::class => ['var' => self::FIXUP_PREC_LEFT],
            \P2Any\PhpParser\Node\Expr\PostDec::class => ['var' => self::FIXUP_PREC_LEFT],
            \P2Any\PhpParser\Node\Expr\Instanceof_::class => ['expr' => self::FIXUP_PREC_LEFT, 'class' => self::FIXUP_PREC_RIGHT],
            \P2Any\PhpParser\Node\Expr\Ternary::class => ['cond' => self::FIXUP_PREC_LEFT, 'else' => self::FIXUP_PREC_RIGHT],
            \P2Any\PhpParser\Node\Expr\FuncCall::class => ['name' => self::FIXUP_CALL_LHS],
            \P2Any\PhpParser\Node\Expr\StaticCall::class => ['class' => self::FIXUP_DEREF_LHS],
            \P2Any\PhpParser\Node\Expr\ArrayDimFetch::class => ['var' => self::FIXUP_DEREF_LHS],
            \P2Any\PhpParser\Node\Expr\ClassConstFetch::class => ['var' => self::FIXUP_DEREF_LHS],
            \P2Any\PhpParser\Node\Expr\New_::class => ['class' => self::FIXUP_DEREF_LHS],
            // TODO: FIXUP_NEW_VARIABLE
            \P2Any\PhpParser\Node\Expr\MethodCall::class => ['var' => self::FIXUP_DEREF_LHS, 'name' => self::FIXUP_BRACED_NAME],
            \P2Any\PhpParser\Node\Expr\NullsafeMethodCall::class => ['var' => self::FIXUP_DEREF_LHS, 'name' => self::FIXUP_BRACED_NAME],
            \P2Any\PhpParser\Node\Expr\StaticPropertyFetch::class => ['class' => self::FIXUP_DEREF_LHS, 'name' => self::FIXUP_VAR_BRACED_NAME],
            \P2Any\PhpParser\Node\Expr\PropertyFetch::class => ['var' => self::FIXUP_DEREF_LHS, 'name' => self::FIXUP_BRACED_NAME],
            \P2Any\PhpParser\Node\Expr\NullsafePropertyFetch::class => ['var' => self::FIXUP_DEREF_LHS, 'name' => self::FIXUP_BRACED_NAME],
            \P2Any\PhpParser\Node\Scalar\Encapsed::class => ['parts' => self::FIXUP_ENCAPSED],
        ];
        $binaryOps = [\P2Any\PhpParser\Node\Expr\BinaryOp\Pow::class, \P2Any\PhpParser\Node\Expr\BinaryOp\Mul::class, \P2Any\PhpParser\Node\Expr\BinaryOp\Div::class, \P2Any\PhpParser\Node\Expr\BinaryOp\Mod::class, \P2Any\PhpParser\Node\Expr\BinaryOp\Plus::class, \P2Any\PhpParser\Node\Expr\BinaryOp\Minus::class, \P2Any\PhpParser\Node\Expr\BinaryOp\Concat::class, \P2Any\PhpParser\Node\Expr\BinaryOp\ShiftLeft::class, \P2Any\PhpParser\Node\Expr\BinaryOp\ShiftRight::class, \P2Any\PhpParser\Node\Expr\BinaryOp\Smaller::class, \P2Any\PhpParser\Node\Expr\BinaryOp\SmallerOrEqual::class, \P2Any\PhpParser\Node\Expr\BinaryOp\Greater::class, \P2Any\PhpParser\Node\Expr\BinaryOp\GreaterOrEqual::class, \P2Any\PhpParser\Node\Expr\BinaryOp\Equal::class, \P2Any\PhpParser\Node\Expr\BinaryOp\NotEqual::class, \P2Any\PhpParser\Node\Expr\BinaryOp\Identical::class, \P2Any\PhpParser\Node\Expr\BinaryOp\NotIdentical::class, \P2Any\PhpParser\Node\Expr\BinaryOp\Spaceship::class, \P2Any\PhpParser\Node\Expr\BinaryOp\BitwiseAnd::class, \P2Any\PhpParser\Node\Expr\BinaryOp\BitwiseXor::class, \P2Any\PhpParser\Node\Expr\BinaryOp\BitwiseOr::class, \P2Any\PhpParser\Node\Expr\BinaryOp\BooleanAnd::class, \P2Any\PhpParser\Node\Expr\BinaryOp\BooleanOr::class, \P2Any\PhpParser\Node\Expr\BinaryOp\Coalesce::class, \P2Any\PhpParser\Node\Expr\BinaryOp\LogicalAnd::class, \P2Any\PhpParser\Node\Expr\BinaryOp\LogicalXor::class, \P2Any\PhpParser\Node\Expr\BinaryOp\LogicalOr::class];
        foreach ($binaryOps as $binaryOp) {
            $this->fixupMap[$binaryOp] = ['left' => self::FIXUP_PREC_LEFT, 'right' => self::FIXUP_PREC_RIGHT];
        }
        $assignOps = [\P2Any\PhpParser\Node\Expr\Assign::class, \P2Any\PhpParser\Node\Expr\AssignRef::class, \P2Any\PhpParser\Node\Expr\AssignOp\Plus::class, \P2Any\PhpParser\Node\Expr\AssignOp\Minus::class, \P2Any\PhpParser\Node\Expr\AssignOp\Mul::class, \P2Any\PhpParser\Node\Expr\AssignOp\Div::class, \P2Any\PhpParser\Node\Expr\AssignOp\Concat::class, \P2Any\PhpParser\Node\Expr\AssignOp\Mod::class, \P2Any\PhpParser\Node\Expr\AssignOp\BitwiseAnd::class, \P2Any\PhpParser\Node\Expr\AssignOp\BitwiseOr::class, \P2Any\PhpParser\Node\Expr\AssignOp\BitwiseXor::class, \P2Any\PhpParser\Node\Expr\AssignOp\ShiftLeft::class, \P2Any\PhpParser\Node\Expr\AssignOp\ShiftRight::class, \P2Any\PhpParser\Node\Expr\AssignOp\Pow::class, \P2Any\PhpParser\Node\Expr\AssignOp\Coalesce::class];
        foreach ($assignOps as $assignOp) {
            $this->fixupMap[$assignOp] = ['var' => self::FIXUP_PREC_LEFT, 'expr' => self::FIXUP_PREC_RIGHT];
        }
        $prefixOps = [\P2Any\PhpParser\Node\Expr\BitwiseNot::class, \P2Any\PhpParser\Node\Expr\BooleanNot::class, \P2Any\PhpParser\Node\Expr\UnaryPlus::class, \P2Any\PhpParser\Node\Expr\UnaryMinus::class, \P2Any\PhpParser\Node\Expr\Cast\Int_::class, \P2Any\PhpParser\Node\Expr\Cast\Double::class, \P2Any\PhpParser\Node\Expr\Cast\String_::class, \P2Any\PhpParser\Node\Expr\Cast\Array_::class, \P2Any\PhpParser\Node\Expr\Cast\Object_::class, \P2Any\PhpParser\Node\Expr\Cast\Bool_::class, \P2Any\PhpParser\Node\Expr\Cast\Unset_::class, \P2Any\PhpParser\Node\Expr\ErrorSuppress::class, \P2Any\PhpParser\Node\Expr\YieldFrom::class, \P2Any\PhpParser\Node\Expr\Print_::class, \P2Any\PhpParser\Node\Expr\Include_::class];
