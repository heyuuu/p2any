...
class Interface_ extends \P2Any\PhpParser\Builder\Declaration
{
    protected $name;
    protected $extends = [];
    protected $constants = [];
    ...
    public function extend(...$interfaces)
    {
        foreach ($interfaces as $interface) {
            $this->extends[] = \P2Any\PhpParser\BuilderHelpers::normalizeName($interface);
        }
        return $this;
    }
    /**
    ...
    {
        return new \P2Any\PhpParser\Node\Stmt\Interface_($this->name, ['extends' => $this->extends, 'stmts' => array_merge($this->constants, $this->methods), 'attrGroups' => $this->attributeGroups], $this->attributes);
    }
}