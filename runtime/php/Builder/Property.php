...
class Property implements \P2Any\PhpParser\Builder
{
    protected $name;
    protected $flags = 0;
    ...
    {
        $this->flags = \P2Any\PhpParser\BuilderHelpers::addModifier($this->flags, \P2Any\PhpParser\Node\Stmt\Class_::MODIFIER_STATIC);
        return $this;
    }
    /**
    ...
    {
        $this->flags = \P2Any\PhpParser\BuilderHelpers::addModifier($this->flags, \P2Any\PhpParser\Node\Stmt\Class_::MODIFIER_READONLY);
        return $this;
    }
    /**
    ...
    {
        $this->default = \P2Any\PhpParser\BuilderHelpers::normalizeValue($value);
        return $this;
    }
    /**
    ...
    {
        $this->type = \P2Any\PhpParser\BuilderHelpers::normalizeType($type);
        return $this;
    }
    /**
    ...
    {
        return new \P2Any\PhpParser\Node\Stmt\Property($this->flags !== 0 ? $this->flags : \P2Any\PhpParser\Node\Stmt\Class_::MODIFIER_PUBLIC, [new \P2Any\PhpParser\Node\Stmt\PropertyProperty($this->name, $this->default)], $this->attributes, $this->type, $this->attributeGroups);
    }
}