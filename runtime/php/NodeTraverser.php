...
class NodeTraverser implements \P2Any\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    protected function traverseNode(\P2Any\PhpParser\Node $node) : \P2Any\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \P2Any\PhpParser\Node) {
                $traverseChildren = true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \P2Any\PhpParser\Node) {
    ...
    {
        if ($old instanceof \P2Any\PhpParser\Node\Stmt && $new instanceof \P2Any\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \P2Any\PhpParser\Node\Expr && $new instanceof \P2Any\PhpParser\Node\Stmt) {
